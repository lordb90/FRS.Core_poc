...
//{
//    public class DlmasterConfiguration : IEntityTypeConfiguration<Dlmaster>
//    {
//        public void Configure(EntityTypeBuilder<Dlmaster> builder)
//        {
//            builder.HasNoKey()
//                .ToTable("DLMASTER");
...
//                .ValueGeneratedOnAdd()
//                .HasColumnName("ID");
//            builder.Property(e => e.Inuse).HasColumnName("INUSE");
...
//            builder.Property(e => e.OthSrch)
//                .HasMaxLength(12)
//                .IsUnicode(false)
//                .HasDefaultValueSql("('')")
//                .HasColumnName("OTH_SRCH");
