...
public class CompDpoConfiguration : IEntityTypeConfiguration<CompDpo>
{
    public void Configure(EntityTypeBuilder<CompDpo> builder)
    {
        builder
            .HasNoKey()
            .ToTable("COMP_DPO");
        ...
        builder.Property(e => e.SrchCty2).HasColumnName("SRCH_CTY2");
