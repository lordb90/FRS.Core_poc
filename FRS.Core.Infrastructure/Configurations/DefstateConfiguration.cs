...
{
    public class DefstateConfiguration : IEntityTypeConfiguration<Defstate>
    {
        public void Configure(EntityTypeBuilder<Defstate> builder)
        {
            builder
                .HasNoKey()
                .ToTable("DEFSTATE");
            ...
            builder.Property(e => e.CvlEc10)
                .HasColumnType("numeric(8, 2)")
                .HasColumnName("CVL_EC_10");
            builder.Property(e => e.CvlEc15)
                .HasColumnType("numeric(8, 2)")
                .HasColumnName("CVL_EC_15");
