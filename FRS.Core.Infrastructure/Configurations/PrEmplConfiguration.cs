...
{
    public class PrEmplConfiguration : IEntityTypeConfiguration<PrEmpl>
    {
        public void Configure(EntityTypeBuilder<PrEmpl> builder)
        {
            builder
                .HasNoKey()
                .ToTable("PR_EMPL");
            ...
            builder.Property(e => e.EmpNotes)
                .IsUnicode(false)
                .HasDefaultValueSql("('')")
                .HasColumnName("EMP_NOTES");
