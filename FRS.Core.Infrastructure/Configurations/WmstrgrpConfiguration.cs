...
{
    public class WmstrgrpConfiguration : IEntityTypeConfiguration<Wmstrgrp>
    {
        public void Configure(EntityTypeBuilder<Wmstrgrp> builder)
        {
            builder
                .HasNoKey()
                .ToTable("WMSTRGRP");
            ...
            builder.Property(e => e.Grpmembers)
                .HasColumnType("numeric(4, 0)")
                .HasColumnName("GRPMEMBERS");
            ...
            builder.Property(e => e.Id)
                .ValueGeneratedOnAdd()
                .HasColumnName("ID");
            builder.Property(e => e.Indmembers)
                .HasColumnType("numeric(5, 0)")
                .HasColumnName("INDMEMBERS");
            builder.Property(e => e.MstrPhone)
                .HasMaxLength(10)
                .IsUnicode(false)
                .HasDefaultValueSql("('')")
                .HasColumnName("MSTR_PHONE");
