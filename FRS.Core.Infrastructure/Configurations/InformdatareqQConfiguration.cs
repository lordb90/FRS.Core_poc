...
{
    public class InformdatareqQConfiguration : IEntityTypeConfiguration<InformdatareqQ>
    {
        public void Configure(EntityTypeBuilder<InformdatareqQ> builder)
        {
            builder
                .HasNoKey()
                .ToTable("INFORMDATAREQ_Q");
            ...
            builder.Property(e => e.Id)
                .ValueGeneratedOnAdd()
                .HasColumnName("ID");
            builder.Property(e => e.Ifdorderid)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasDefaultValueSql("('')")
                .HasColumnName("IFDORDERID");
