...
{
    public class PrWkcmpConfiguration : IEntityTypeConfiguration<PrWkcmp>
    {
        public void Configure(EntityTypeBuilder<PrWkcmp> builder)
        {
            builder
                .HasNoKey()
                .ToTable("PR_WKCMP");
            ...
            builder.Property(e => e.DatesVer)
                .HasMaxLength(24)
                .IsUnicode(false)
                .HasDefaultValueSql("('')")
                .HasColumnName("DATES_VER");
