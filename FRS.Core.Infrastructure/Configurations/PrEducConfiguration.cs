...
{
    public class PrEducConfiguration : IEntityTypeConfiguration<PrEduc>
    {
        public void Configure(EntityTypeBuilder<PrEduc> builder)
        {
            builder
                .HasNoKey()
                .ToTable("PR_EDUC");
            ...
            builder.Property(e => e.EduNotes)
                .IsUnicode(false)
                .HasDefaultValueSql("('')")
                .HasColumnName("EDU_NOTES");
